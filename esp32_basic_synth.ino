...
#if (defined ADC_TO_MIDI_ENABLED) || (defined MIDI_VIA_USB_ENABLED) || (defined OLED_OSC_DISP_ENABLED) || (defined THEREMIN)
#ifdef ESP32
    Core0TaskInit();
#else
...
void Core0TaskLoop()
{
     ...
     */
//Beginning of theremin code
#ifdef THEREMIN
  //Serial.println("THEREMIN LOOP");
